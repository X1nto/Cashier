...
class RegistrySelectedProductsAdapter(
    ...
    override fun onBindViewHolder(holder: SelectedProductsViewHolder, position: Int) {
        ...
        holder.productCount.text = holder.productCount.context.getString(R.string.product_amount, product.countAsString)
        holder.productPrice.text = holder.productPrice.context.getString(R.string.product_price_sum, product.price.value)
    }
